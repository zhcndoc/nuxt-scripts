---
title: CORS 和安全属性
description: 了解 Nuxt Scripts 如何处理跨源安全。
---
...
当使用 [带有 SRI 的打包脚本](/docs/guides/first-party#subresource-integrity-sri) 时，必须包含 `crossorigin="anonymous"`，Nuxt 会自动添加该属性：
...
如果 CORS 问题持续存在，请考虑 [打包脚本](/docs/guides/first-party) 以从您自己的域名提供服务，从而完全消除 CORS。
