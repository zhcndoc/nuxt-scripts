---
title: 打包远程脚本
description: 通过将第三方脚本与您的应用打包在一起来优化它们。
deprecated: true
redirect: /docs/guides/first-party
---

::callout{type="warning"}
`bundle` 选项已弃用。现在通过 capabilities 系统按脚本自动启用打包功能。请参阅 [第一方模式](/docs/guides/first-party) 了解推荐做法。
::
